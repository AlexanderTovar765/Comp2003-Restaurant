...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 🔍 These helper methods will look for multiple possible names safely
        ...
        if (btnLogin != null) {
            btnLogin.setOnClickListener(v -> {
                ...
                if (valid) {
                    ...
                    // ✅ Send user to HomePageActivity after successful login
    ...
    // 🔧 Finds EditText no matter what it’s named in XML
    ...
    // 🔧 Finds Button no matter what it’s named in XML
